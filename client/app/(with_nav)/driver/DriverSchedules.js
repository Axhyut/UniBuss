    ...
    return (
      ...
      >
        <div className="space-y-4">
          ...
          {schedule.status === "drivery" && currentPnrDetails && (
          ...
          <div className="flex gap-3">
            {/* Show Complete Ride only when status is "drivery" */}
            {schedule.status === "drivery" && (
              <motion.button
            ...
            {/* Show Cancel Schedule when status is "drivery" or "active" */}
            {(schedule.status === "drivery" || schedule.status === "active" || schedule.status === "reserved") && (
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
