      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            {/* Show Complete Ride only when status is "busy" */}
            ...
            {/* Show Cancel Schedule when status is "busy" or "active" */}
            {(schedule.status === "busy" || schedule.status === "active" || schedule.status === "reserved") && (
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
